...
gulp.task('sass', () => {
  gulp.src(`${dirs.src}/sass/**/*.sass`)
    .pipe(plugins().sass.sync({outputStyle: 'expanded'}).on('error', plugins().sass.logError))
    .pipe(gulp.dest(`${dirs.src}/css`))
    .pipe(plugins().sass.sync({outputStyle: 'compressed'}).on('error', plugins().sass.logError))
    .pipe(gulp.dest(`${dirs.src}/css/min`));
})
...
gulp.task('watch', () => {
  gulp.watch([`${dirs.src}/sass/**/*.sass`, `${dirs.src}/sass/**/*.scss`], ['build'])
  gulp.watch([`${dirs.src}/*.html`], ['copy:index.html'])
})
